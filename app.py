...
st.subheader("Financial Conditions: Net R and G Scores")
fig = go.Figure()
...
st.subheader("Monetary Conditions Attribution (Weighted and Normalized)")
...
st.subheader("Growth Conditions Attribution (Weighted and Normalized)")
...
st.subheader("Latest Period Attribution Analysis")
...
st.subheader("Comprehensive Dashboard (All Charts)")
...
st.dataframe(df_norm[['R_score', 'G_score']].tail(12), use_container_width=True)
